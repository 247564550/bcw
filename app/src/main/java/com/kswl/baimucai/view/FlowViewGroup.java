...
/**
 * @author wangjie
 * @package com.kswl.app.activity.flowViewGroup
 * @desc 流式布局
 * @date 2017-2017/3/7-15:17
 */
public class FlowViewGroup extends ViewGroup {
    ...
    public FlowViewGroup(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
...
//            Log.i(TAG, "子View Layout需要的宽高(包含margin)：childWidth:" + childWidth + "   ," +
...
//        Log.i(TAG, "系统测量允许的尺寸最大值：widthMeasure:" + widthMeasure + "   ,heightMeasure:" +
//                heightMeasure);
//        Log.i(TAG, "经过我们测量实际的尺寸(不包括父控件的padding)：maxLineWidth:" + maxLineWidth + "   ," +
...
//        Log.i(TAG, "changed:" + changed + "   ,l:" + l + "  t:" + t + "  r:" + r + "  b:" + b);
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (curLeft + childWidth > rightLimit) {
                ...
                viewR = viewL + childW;
                viewB = viewT + childH;
                //child.layout(baseLeft + params.leftMargin, curTop + params.topMargin, baseLeft
                ...
                // curLeft+childWidth:"+(curLeft+childWidth)+"  curTop+childHeight:"+
                // (curTop+childHeight));
